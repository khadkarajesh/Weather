 ...
 */
public class PinnedTweetsCustomAdapter extends BaseAdapter {
    Context context;
    ...
    String user;
    AQuery aQuery;
    public PinnedTweetsCustomAdapter(Context context,String user,ArrayList<PinnedTweet>tweetList)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //url=databaseHelper.getImageUrlOfPinnedTweet(tweetList.get(0).handle);
        ...
        Picasso.with(context).load(databaseHelper.getImageUrlOfPinnedTweet(tweetList.get(0).userHandle)).into(UserImage);
