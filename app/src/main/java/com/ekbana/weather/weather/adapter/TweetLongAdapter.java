 ...
 */
public class TweetLongAdapter extends PagerAdapter {
    ...
    int pos;
    public TweetLongAdapter(Context context,ArrayList<String>userHandle,HashMap<Integer,ArrayList<PinnedTweet>>hashMap)
    {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        TweetsCustomAdapter tweetsCustomAdapter=new TweetsCustomAdapter(context,userHandle.get(position).toString(),hashMap.get(position));
